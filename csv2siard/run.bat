...
ECHO --------- %time%
ECHO.
php.exe csv2siard.php csvdata\gv-model-v9.xml csvdata test.siard csvdata\gvtg.prefs
REM php.exe csv2siard.php sqldata\gv-model-v9.xml sqldata test.siard sqldata\csvtext.prefs
